...
ax.set_title("Wind Turbines Grouped by KMeans (3 Clusters)", fontsize=25, weight='bold')
ax.axis("off")
...
df[["GSRN", "Cluster"]].to_csv("kmeans_cluster_turbines_3_clusters.csv", index=False)